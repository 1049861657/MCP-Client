...
export function getQueueConnectionOptions(): { url: string; maxRetriesPerRequest: number } {
  return {
    url: getRedisUrl(),
...
export function getWorkerConnectionOptions(): { url: string; maxRetriesPerRequest: null } {
  return {
    url: getRedisUrl(),
